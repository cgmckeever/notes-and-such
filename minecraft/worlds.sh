...
$backups/backup.sh -c -i $minecraft/world_nether -o $backups/world_nether -s minecraft -d sequential -m 30

sleep 10
echo world_the_end
mkdir -p $backups/world_the_end
$backups/backup.sh -c -i $minecraft/world_the_end -o $backups/world_the_end -s minecraft -d sequential -m 30
